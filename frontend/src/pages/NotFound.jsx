...
export default function NotFound() {
  return (
    <div className="flex flex-col justify-center items-center h-screen bg-gray-100 overflow-hidden">
      ...
      >
        <h1 className="text-9xl font-oranienbaum text-blue-500 mb-4">404</h1>
        <h2 className="text-4xl font-poppins text-gray-700 mb-8">
          Page Not Found
        </h2>
        <p className="text-xl font-lato text-gray-600 mb-12">
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <a
            href="/"
            className=" inline-block bg-blue-500 text-white px-8 py-3 rounded-full text-xl font-poppins shadow-lg transition duration-300 ease-in-out hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
          >
            Go Home
          </a>
        </motion.div>
